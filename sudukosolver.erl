...
%% we now want to create grid map  this is fucking wrong wake the fuck up
...
create_row(H, _,1) -> {{"fuck", 1},H}.
% keep hitting fucking 2,1,1 which is the final fucking case.....i am going to kill myself.


%% see your fucking notes...something is very very wrong.  ie its retarded and hits the dumbass case over and over.
